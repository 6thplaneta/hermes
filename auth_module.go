...
func createCollections(app *App) error {
	...
	rolePermColl.Conf().SetAuth("Create Role Permission", "Get Role Permission", "List Role Permission", "Update Role Permission", "Delete Role Permission", "Update Role Permission")
